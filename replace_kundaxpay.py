...
new_func = '''    def scrape_kundaxpay(self):
...
# Find and replace
if 'def scrape_kundaxpay(self):' in content:
    # Find the function start
    start = content.find('    def scrape_kundaxpay(self):')
    # Find the next function definition
    next_func = content.find('    def scrape_all_companies', start)
